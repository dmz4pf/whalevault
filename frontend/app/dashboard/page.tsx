...
export default function DashboardPage() {
  ...
  // Calculate privacy score: shielded / (shielded + wallet)
  const walletBalanceLamports = balance * LAMPORTS_PER_SOL;
  const totalAssets = walletBalanceLamports + shieldedBalance;
  const privacyScore = totalAssets > 0
    ? Math.round((shieldedBalance / totalAssets) * 100)
    : 0;
